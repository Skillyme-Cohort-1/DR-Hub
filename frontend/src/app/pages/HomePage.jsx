    ...
    <div className="min-h-screen bg-[#030303] text-white">
      ...
      <main id="main-content">
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden pt-[4.25rem]">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black/75 via-black/55 to-[#030303]" />
        ...
        <section id="rooms" className="scroll-mt-24 border-t border-white/[0.06] bg-[#030303] px-4 py-20 sm:px-6">
        ...
        <section
          id="amenities"
          className="scroll-mt-24 border-t border-white/[0.06] bg-[#050505] px-4 py-20 sm:px-6 lg:py-28"
        >
              ...
              <ul className="mt-10 space-y-5">
                {[
                  ...
                  <li key={text} className="flex gap-4">
                    ...
                    <span className="pt-2 text-lg text-white/75">{text}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <section
          id="process"
          className="scroll-mt-24 border-t border-white/[0.06] bg-[#030303] px-4 py-20 sm:px-6 lg:py-28"
        >
          <div className="mx-auto max-w-[1280px]">
            ...
            <ol className="grid gap-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
              {steps.map((step, index) => (
                <li
                  key={step.number}
                  className="relative rounded-2xl border border-white/[0.08] bg-zinc-900/30 p-6 pt-8 transition-colors hover:border-[#E87722]/25"
                >
                  <span
                  ...
                  {index < steps.length - 1 ? (
                    <span
                      className="pointer-events-none absolute -right-4 top-1/2 hidden h-px w-8 -translate-y-1/2 bg-gradient-to-r from-white/20 to-transparent lg:block"
                      aria-hidden
                    />
                  ) : null}
                </li>
        ...
        <section
          id="testimonials"
          className="scroll-mt-24 border-t border-white/[0.06] bg-[#050505] px-4 py-20 sm:px-6 lg:py-24"
        >
          <div className="mx-auto max-w-[1280px]">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              {testimonials.map((t) => (
                <Card
                  key={t.name}
                  className="border border-white/10 bg-zinc-900/35 p-0 transition-all duration-300 hover:-translate-y-1 hover:border-[#E87722]/40"
                >
